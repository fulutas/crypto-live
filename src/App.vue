        ...
        <div class="flex justify-between w-3/4">
          ...
          <div>
            ...
            <p
              ...
              v-if="$filters.price_change(coin.price_change_percentage_24h)">
  ...
  <div class="container mx-auto pt-18 pb-48 px-2">
    ...
    <table class="table-fixed cursor-pointer">
      ...
      <tbody class="divide-y">
        <!-- 1 -->
        <tr class="text-sm hover:bg-gray-100 transition duration-300" v-for="coin in matchingNames" :key="coin.name">
...
export default {
  name: "App",
  setup() {
    const api = ref('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=1&sparkline=false&price_change_percentage=1h');
    const coins = ref([]);
    const clone = ref([])
    const search = ref('')
